...
private def parserRules : List (String × CRule) := [
  ...
  ("str-update-neg", .str_update_neg),
  ("str-update-oob", .str_update_oob),
  ("str-update-empty", .str_update_empty),
  ("str-update-rev", .str_update_rev),
  ("str-update-fit", .str_update_fit),
  ("str-update-concat-fit0", .str_update_concat_fit0),
  ("str-update-concat-fit", .str_update_concat_fit),
  ("str-update-concat-fit2", .str_update_concat_fit2),
  ...
  ("str-replace-prefix-concat", .str_replace_prefix_concat),
  ...
  ("str-replace-all-find-pre", .str_replace_all_find_pre),
  ("str-replace-all-find", .str_replace_all_find),
  ...
  ("str-indexof-prefix-concat", .str_indexof_prefix_concat),
  ("str-indexof-len-oob", .str_indexof_len_oob),
  ("str-indexof-len-oob2", .str_indexof_len_oob2),
  ...
  ("str-to-lower-idem", .str_to_lower_idem),
  ("str-to-upper-lower", .str_to_upper_lower),
  ("str-to-upper-idem", .str_to_upper_idem),
  ...
  ("seq-nth-concat-unit", .seq_nth_concat_unit),
  ("seq-nth-concat-unit-gen", .seq_nth_concat_unit_gen),
  ("seq-nth-concat-unit-gen2", .seq_nth_concat_unit_gen2),
