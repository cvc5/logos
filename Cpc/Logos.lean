...
def __eo_dt_apply_list : Term -> Term -> Term
  | Term.Stuck , _  => Term.Stuck
  | _ , Term.Stuck  => Term.Stuck
  | a, (Term.Apply (Term.Apply Term.__eo_List_cons c) cs) => (__eo_mk_apply (Term.Apply Term.__eo_List_cons (Term.Apply c a)) (__eo_dt_apply_list a cs))
  | a, cs => Term.__eo_List_nil


def __eo_dt_constructors : Term -> Term
  | Term.Stuck  => Term.Stuck
  | (Term.Apply T U) => (native_ite (native_teq (__eo_dt_param_at T native_nat_zero) Term.Type) (__eo_dt_constructors_main (Term.Apply T U)) (__eo_dt_apply_list U (__eo_dt_constructors T)))
...
def __eo_dt_selectors : Term -> Term
  | Term.Stuck  => Term.Stuck
  | (Term.Apply t U) => (native_ite (native_teq (__eo_dt_param_at t native_nat_zero) Term.Type) (__eo_dt_selectors_main (Term.Apply t U)) (__eo_dt_apply_list U (__eo_dt_selectors t)))
