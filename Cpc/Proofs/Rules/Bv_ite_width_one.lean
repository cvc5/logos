...
private theorem prog_bv_ite_width_one_eq_of_ne_stuck (c1 : Term) :
    c1 ≠ Term.Stuck ->
    __eo_prog_bv_ite_width_one c1 =
  ...
  intro hC1
  cases c1 <;> simp [__eo_prog_bv_ite_width_one] at hC1 ⊢

private theorem typeof_width_one_ite_not_stuck_implies_cond
    (cTy : Term) :
    __eo_typeof_ite
        (__eo_typeof_eq cTy
...
private theorem typeof_arg_of_prog_bv_ite_width_one_bool (c1 : Term) :
  ...
  · rw [prog_bv_ite_width_one_eq_of_ne_stuck c1 hC1] at hTy
    ...
    exact typeof_width_one_ite_not_stuck_implies_cond (__eo_typeof c1) hLeftNN
...
private theorem smt_typeof_bv_ite_width_one
  ...
  have hC1Type := typeof_arg_of_prog_bv_ite_width_one_bool c1 hResultTy
...
private theorem typed___eo_prog_bv_ite_width_one_impl (c1 : Term) :
    RuleProofs.eo_has_smt_translation c1 ->
    __eo_typeof (__eo_prog_bv_ite_width_one c1) = Term.Bool ->
    RuleProofs.eo_has_bool_type (__eo_prog_bv_ite_width_one c1) := by
  intro hC1Trans hResultTy
  have hC1NotStuck : c1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation c1 hC1Trans
  rw [prog_bv_ite_width_one_eq_of_ne_stuck c1 hC1NotStuck]
  exact RuleProofs.eo_has_bool_type_eq_of_same_smt_type
    ...
    (smt_typeof_bv_ite_width_one c1 hC1Trans hResultTy)
    (by
      rw [smt_typeof_bv_ite_width_one c1 hC1Trans hResultTy]
      exact hC1Trans)
...
private theorem facts___eo_prog_bv_ite_width_one_impl
  ...
  have hC1NotStuck : c1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation c1 hC1Trans
  have hProgBool : RuleProofs.eo_has_bool_type (__eo_prog_bv_ite_width_one c1) :=
    typed___eo_prog_bv_ite_width_one_impl c1 hC1Trans hResultTy
  rw [prog_bv_ite_width_one_eq_of_ne_stuck c1 hC1NotStuck]
  apply RuleProofs.eo_interprets_eq_of_rel M
  · simpa [prog_bv_ite_width_one_eq_of_ne_stuck c1 hC1NotStuck] using hProgBool
      ...
      (__smtx_model_eval M
        (__eo_to_smt
          (Term.Apply (Term.Apply (Term.Apply (Term.UOp UserOp.ite)
            ...
            (Term.Apply (Term.UOp1 UserOp1.int_to_bv (Term.Numeral 1)) (Term.Numeral 0)))))
      (__smtx_model_eval M (__eo_to_smt c1))
    rw [eval_bv_ite_width_one M hM c1 hC1Trans hResultTy]
...
public theorem cmd_step_bv_ite_width_one_properties
  ...
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_ite_width_one args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_ite_width_one args premises) :=
by
  intro hCmdTrans _hPremisesBool hResultTy
  have hProg : __eo_cmd_step_proven s CRule.bv_ite_width_one args premises ≠ Term.Stuck :=
  ...
  | cons a1 args =>
      ...
      | nil =>
          ...
          | nil =>
              ...
              change __eo_typeof (__eo_prog_bv_ite_width_one a1) = Term.Bool
                at hResultTy
              refine ⟨?_, ?_⟩
              · intro _hTrue
                change eo_interprets M (__eo_prog_bv_ite_width_one a1) true
                exact facts___eo_prog_bv_ite_width_one_impl M hM a1
                  hA1Trans hResultTy
              · exact RuleProofs.eo_has_smt_translation_of_has_bool_type _
                  (typed___eo_prog_bv_ite_width_one_impl a1 hA1Trans hResultTy)
          | cons _ _ =>
              change Term.Stuck ≠ Term.Stuck at hProg
              exact False.elim (hProg rfl)
      | cons _ _ =>
