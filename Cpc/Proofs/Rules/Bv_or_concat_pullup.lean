...
public theorem cmd_step_bv_or_concat_pullup_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.bv_or_concat_pullup args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_or_concat_pullup args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_or_concat_pullup args premises) :=
by
                        ...
                        | cons n3 premises =>
                          ...
                          | nil =>
                            ...
                            change StepRuleProperties M [P1, P2, P3]
                              (__eo_prog_bv_or_concat_pullup xs ws y z ys
                            ...
                            have hResultTyLocal : __eo_typeof
                                (bvConcatPullup1Program .bor xs ws y z ys
                            ...
                            simpa [bvConcatPullup1Program, P1, P2, P3] using
                              (bvConcatPullup1ProgramProperties M hM .bor
