...
public theorem cmd_step_bv_mult_pow2_1_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.bv_mult_pow2_1 args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_mult_pow2_1 args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_mult_pow2_1 args premises) :=
by
                                          ...
                                          | cons n3 premises =>
                                              ...
                                              | nil =>
                                                  ...
                                                  change StepRuleProperties M
                                                    [P1, P2, P3]
                                                    (BvMultPow2NarySupport.posProgram
                                                  ...
                                                  · intro hPremisesTrue
                                                    ...
                                                    exact
                                                      BvMultPow2NarySupport.facts_pos_program
                                                  ...
                                                  · exact
                                                      RuleProofs.eo_has_smt_translation_of_has_bool_type
                                                        _
                                                        (BvMultPow2NarySupport.typed_pos_program
                                                          xs ys z size n exponent u
                                                          P1 P2 P3 hXsTrans hYsTrans
                                                          hZTrans hSizeTrans hNTrans
                                                          hExponentTrans hUTrans hProgramTy)
