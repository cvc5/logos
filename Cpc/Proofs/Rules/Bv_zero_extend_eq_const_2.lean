...
public theorem cmd_step_bv_zero_extend_eq_const_2_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.bv_zero_extend_eq_const_2 args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_zero_extend_eq_const_2 args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_zero_extend_eq_const_2 args premises) :=
by
                                  ...
                                  | cons n2 premises =>
                                      ...
                                      | nil =>
                                          ...
                                          · intro hPremisesTrue
                                            ...
                                            exact
                                              facts_bv_zero_extend_eq_const_2_program
                                          ...
                                          · exact
                                              RuleProofs.eo_has_smt_translation_of_has_bool_type
                                                _
                                                (typed_bv_zero_extend_eq_const_2_program
                                                  x m c nm nm2 nmm1 P1 P2
                                                  hXTrans hMTrans hCTrans hNmTrans
                                                  hNm2Trans hNmm1Trans hProgramTy)
