...
private theorem prog_bv_shl_zero_eq_of_ne_stuck (a1 n1 : Term) :
    a1 ≠ Term.Stuck ->
    n1 ≠ Term.Stuck ->
    __eo_prog_bv_shl_zero a1 n1 =
      Term.Apply (Term.Apply (Term.UOp UserOp.eq)
        (Term.Apply (Term.Apply (Term.UOp UserOp.bvshl)
          (Term.Apply (Term.UOp1 UserOp1.int_to_bv n1) (Term.Numeral 0))) a1))
        (Term.Apply (Term.UOp1 UserOp1.int_to_bv n1) (Term.Numeral 0)) := by
  intro hA1 hN1
  cases a1 <;> cases n1 <;> simp [__eo_prog_bv_shl_zero] at hA1 hN1 ⊢
...
private theorem typeof_args_of_prog_bv_shl_zero_bool (a1 n1 : Term) :
  ...
  · by_cases hN1 : n1 = Term.Stuck
    · subst n1
      cases a1 <;> simp [__eo_prog_bv_shl_zero] at hA1 hTy
      all_goals
        have hStuckTy : __eo_typeof Term.Stuck ≠ Term.Bool := by
          native_decide
        exact False.elim (hStuckTy hTy)
    · rw [prog_bv_shl_zero_eq_of_ne_stuck a1 n1 hA1 hN1] at hTy
...
private theorem smt_typeof_bvshl_zero_eq_zero
    (a1 n1 : Term) :
  ...
  rcases typeof_args_of_prog_bv_shl_zero_bool a1 n1 hResultTy with
    ⟨w, hA1Type, hN1, _hW⟩
...
private theorem typed___eo_prog_bv_shl_zero_impl (a1 n1 : Term) :
    RuleProofs.eo_has_smt_translation a1 ->
    __eo_typeof (__eo_prog_bv_shl_zero a1 n1) = Term.Bool ->
    RuleProofs.eo_has_bool_type (__eo_prog_bv_shl_zero a1 n1) := by
  intro hA1Trans hResultTy
  ...
  rcases typeof_args_of_prog_bv_shl_zero_bool a1 n1 hResultTy with
    ⟨w, _hA1Type, hN1, hW⟩
  subst n1
  rw [prog_bv_shl_zero_eq_of_ne_stuck a1 w hA1NotStuck hW]
  exact RuleProofs.eo_has_bool_type_eq_of_same_smt_type
    ...
    (smt_typeof_bvshl_zero_eq_zero a1 w hA1Trans (by simpa using hResultTy))
    (by
      rw [smt_typeof_bvshl_zero_eq_zero a1 w hA1Trans (by simpa using hResultTy)]
      rcases typeof_args_of_prog_bv_shl_zero_bool a1 w (by simpa using hResultTy) with
        ⟨w', hA1Type, hWEq, _hW'⟩
      subst w'
      rcases smt_bitvec_type_of_eo_bitvec_type_with_width a1 w hA1Trans hA1Type with
...
private theorem eval_bvshl_zero_self
  ...
  simp [__smtx_model_eval_bvshl, SmtEval.native_zmult, SmtEval.native_mod_total]

private theorem facts___eo_prog_bv_shl_zero_impl
    (M : SmtModel) (hM : model_wf M) (a1 n1 : Term) :
    RuleProofs.eo_has_smt_translation a1 ->
    __eo_typeof (__eo_prog_bv_shl_zero a1 n1) = Term.Bool ->
    eo_interprets M (__eo_prog_bv_shl_zero a1 n1) true := by
  intro hA1Trans hResultTy
  have hA1NotStuck : a1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation a1 hA1Trans
  rcases typeof_args_of_prog_bv_shl_zero_bool a1 n1 hResultTy with
    ⟨w, _hA1Type, hN1, hW⟩
  subst n1
  have hProgBool : RuleProofs.eo_has_bool_type (__eo_prog_bv_shl_zero a1 w) :=
    typed___eo_prog_bv_shl_zero_impl a1 w hA1Trans (by simpa using hResultTy)
  rw [prog_bv_shl_zero_eq_of_ne_stuck a1 w hA1NotStuck hW]
  apply RuleProofs.eo_interprets_eq_of_rel M
  · simpa [prog_bv_shl_zero_eq_of_ne_stuck a1 w hA1NotStuck hW] using hProgBool
  · change RuleProofs.smt_value_rel
    ...
    rw [eval_bvshl_zero_self M hM a1 w hA1Trans (by simpa using hResultTy)]
    exact RuleProofs.smt_value_rel_refl
      (__smtx_model_eval M (__eo_to_smt (Term.Apply (Term.UOp1 UserOp1.int_to_bv w) (Term.Numeral 0))))

public theorem cmd_step_bv_shl_zero_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.bv_shl_zero args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_shl_zero args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_shl_zero args premises) :=
by
  intro hCmdTrans _hPremisesBool hResultTy
  have hProg : __eo_cmd_step_proven s CRule.bv_shl_zero args premises ≠ Term.Stuck :=
      ...
      | cons a2 args =>
          ...
          | nil =>
              ...
              | nil =>
                  ...
                  change __eo_typeof (__eo_prog_bv_shl_zero a1 a2) = Term.Bool
                    at hResultTy
                  refine ⟨?_, ?_⟩
                  · intro _hTrue
                    change eo_interprets M (__eo_prog_bv_shl_zero a1 a2) true
                    exact facts___eo_prog_bv_shl_zero_impl M hM a1 a2
                      hA1Trans hResultTy
                  · exact RuleProofs.eo_has_smt_translation_of_has_bool_type _
                      (typed___eo_prog_bv_shl_zero_impl a1 a2 hA1Trans hResultTy)
              | cons _ _ =>
                  change Term.Stuck ≠ Term.Stuck at hProg
                  exact False.elim (hProg rfl)
          | cons _ _ =>
