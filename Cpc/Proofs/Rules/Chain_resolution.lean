...
public theorem cmd_step_chain_resolution_properties
  ...
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.chain_resolution args premises) :=
by
  exact cmd_step_chain_resolution_properties_aux M hM s args premises
