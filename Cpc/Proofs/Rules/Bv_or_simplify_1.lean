...
public theorem cmd_step_bv_or_simplify_1_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.bv_or_simplify_1 args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_or_simplify_1 args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_or_simplify_1 args premises) :=
by
                          ...
                          | cons i1 premises =>
                              ...
                              | nil =>
                                  ...
                                  have hProgLocal :
                                    ...
                                    exact hsimpa
                                  rcases
                                      BvOrSimplifySupport.program1_shape_of_ne_stuck
                                  ...
                                  rw [__eo_prog_bv_or_simplify_1.eq_6
                                  ...
                                  have hArgTranslations :
                                    ...
                                    simpa [cmdTranslationOk,
                                      ...
                                      hCmdTrans
                                  rcases
                                      BvOrSimplifySupport.inferred_argument_types1
                                        a1 a2 a3 a4 a5
                                        hArgTranslations.1
                                  ...
                                  simpa [P1, hP1, hProgEq] using
                                    (show StepRuleProperties M
                                      ...
                                      ⟨(by
                                          ...
                                          exact
                                            BvOrSimplifySupport.facts_term1_of_type_or_nil
                                              M hM a1 a2 a3 a4 a5 W
                                              hA1Ty hA2Ty hA3Ty hA4Ty
                                              hA5 hW0 hA1List hA2List hA3List),
                                        RuleProofs.eo_has_smt_translation_of_has_bool_type _
                                          (BvOrSimplifySupport.typed_term1_of_type_or_nil
                                            a1 a2 a3 a4 a5 W
                                            hA1Ty hA2Ty hA3Ty hA4Ty
                                            hA5 hW0 hA1List hA2List hA3List)⟩)
