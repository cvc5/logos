...
public theorem cmd_step_bv_not_xor_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.bv_not_xor args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_not_xor args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_not_xor args premises) :=
by
  intro hCmdTrans _hPremisesBool hResultTy
  have hProg : __eo_cmd_step_proven s CRule.bv_not_xor args premises ≠ Term.Stuck :=
          ...
          | cons a3 args =>
              ...
              | nil =>
                  ...
                  | nil =>
                      ...
                      change __eo_typeof (bvNotXorProgram a1 a2 a3) =
                        Term.Bool at hResultTy
                      refine ⟨?_, ?_⟩
                      · intro _hTrue
                        change eo_interprets M (bvNotXorProgram a1 a2 a3) true
                        exact facts_bv_not_xor_program M hM a1 a2 a3
                          hA1Trans hA2Trans hA3Trans hResultTy
                      · exact RuleProofs.eo_has_smt_translation_of_has_bool_type _
                          (typed_bv_not_xor_program a1 a2 a3 hA1Trans
