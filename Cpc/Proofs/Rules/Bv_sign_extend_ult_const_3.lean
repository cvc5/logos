...
public theorem cmd_step_bv_sign_extend_ult_const_3_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.bv_sign_extend_ult_const_3 args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_sign_extend_ult_const_3 args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_sign_extend_ult_const_3 args premises) :=
by
                              ...
                              | cons n2 premises =>
                                  ...
                                  | nil =>
                                      ...
                                      · intro hPremisesTrue
                                        ...
                                        exact facts_bv_sign_extend_ult_const_3_program
                                      ...
                                      · exact
                                          RuleProofs.eo_has_smt_translation_of_has_bool_type
                                            _
                                            (typed_bv_sign_extend_ult_const_3_program
