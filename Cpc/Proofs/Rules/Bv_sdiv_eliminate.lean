...
public theorem cmd_step_bv_sdiv_eliminate_properties
  ...
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_sdiv_eliminate args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_sdiv_eliminate args premises) :=
by
                  ...
                  | cons n1 premises =>
                      ...
                      | nil =>
                          ...
                          change StepRuleProperties M [P1]
                            (__eo_prog_bv_sdiv_eliminate a1 a2 a3
                              (Proof.pf P1))
                          have hProgLocal :
                              __eo_prog_bv_sdiv_eliminate a1 a2 a3
                          ...
                          have hResultTyCanonical :
                              __eo_typeof (bvSdivProgram a1 a2 a3) =
                                Term.Bool := by
                            have h := hResultTy
                            change __eo_typeof
                                (__eo_prog_bv_sdiv_eliminate a1 a2 a3
                              ...
                              Term.Bool at h
                            simpa [P1, hP1, bvSdivProgram] using h
                          simpa [hP1, bvSdivProgram] using
                            (show StepRuleProperties M
                                [bvSdivPrem a1 a3]
                                (bvSdivProgram a1 a2 a3) from
                              ⟨(by
                                  intro hPremisesTrue
                                  have hPrem :
                                      eo_interprets M
                                  ...
                                  exact facts_bv_sdiv_program M hM a1 a2 a3
                                    hA1Trans hA2Trans hA3Trans hPrem
                                    hResultTyCanonical),
                                RuleProofs.eo_has_smt_translation_of_has_bool_type _
                                  (typed_bv_sdiv_program a1 a2 a3
