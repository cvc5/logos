...
public theorem cmd_step_sets_inter_emp2_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.sets_inter_emp2 args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.sets_inter_emp2 args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.sets_inter_emp2 args premises) :=
by
              ...
              | nil =>
                  ...
                  | cons n premises =>
                      ...
                      | nil =>
                          ...
                          change
                            __eo_typeof
                                (__eo_prog_sets_inter_emp2 x y ty
                                  (Proof.pf P)) = Term.Bool at hResultTy
                          have hProgRule :
                              __eo_prog_sets_inter_emp2 x y ty
                                  (Proof.pf P) ≠ Term.Stuck :=
                            term_ne_stuck_of_typeof_bool hResultTy
                          rcases SetsBasicRewritesSupport.prog_sets_inter_emp2_info
                          ...
                          have hFormulaTy :
                              __eo_typeof
                                  (SetsBasicRewritesSupport.mkEq
                                    (SetsBasicRewritesSupport.mkSetInter x y)
                                    y) = Term.Bool := by
                          ...
                          have hFormulaBool :
                              RuleProofs.eo_has_bool_type
                                (SetsBasicRewritesSupport.mkEq
                                  (SetsBasicRewritesSupport.mkSetInter x y)
                                  y) :=
                            SetsBasicRewritesSupport.typed_set_inter_eq_right
                          ...
                          · intro hTrue
                            ...
                            exact RuleProofs.eo_interprets_eq_of_rel M
                              (SetsBasicRewritesSupport.mkSetInter x y) y
                              hFormulaBool
                              (SetsBasicRewritesSupport.set_inter_empty_right_rel_of_premise_bool
