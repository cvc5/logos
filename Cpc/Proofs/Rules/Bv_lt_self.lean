...
private theorem prog_bv_lt_self_eq_of_ne_stuck (x1 : Term) :
    x1 ≠ Term.Stuck ->
    __eo_prog_bv_lt_self x1 =
      Term.Apply (Term.Apply Term.eq
        (Term.Apply (Term.Apply (Term.UOp UserOp.bvslt) x1) x1))
        (Term.Boolean false) := by
  intro hX1
  cases x1 <;> simp [__eo_prog_bv_lt_self] at hX1 ⊢

private theorem typeof_arg_of_prog_bv_lt_self_bool (x1 : Term) :
  ...
  · rw [prog_bv_lt_self_eq_of_ne_stuck x1 hX1] at hTy
    change __eo_typeof_eq (__eo_typeof (Term.Apply (Term.Apply (Term.UOp UserOp.bvslt) x1) x1))
...
private theorem eo_has_bool_type_bvslt_self
    (x1 : Term) :
    RuleProofs.eo_has_smt_translation x1 ->
    __eo_typeof (__eo_prog_bv_lt_self x1) = Term.Bool ->
    RuleProofs.eo_has_bool_type (Term.Apply (Term.Apply (Term.UOp UserOp.bvslt) x1) x1) := by
  intro hX1Trans hResultTy
  rcases typeof_arg_of_prog_bv_lt_self_bool x1 hResultTy with ⟨w, hX1Type, _hW⟩
  rcases smt_bitvec_type_of_eo_bitvec_type x1 w hX1Trans hX1Type with ⟨n, hSmtTy⟩
  unfold RuleProofs.eo_has_bool_type
  change __smtx_typeof (SmtTerm.bvslt (__eo_to_smt x1) (__eo_to_smt x1)) = SmtType.Bool
  rw [__smtx_typeof.eq_60]
  simp [__smtx_typeof_bv_op_2_ret, hSmtTy, native_nateq, native_ite]

private theorem typed___eo_prog_bv_lt_self_impl (x1 : Term) :
    RuleProofs.eo_has_smt_translation x1 ->
    __eo_typeof (__eo_prog_bv_lt_self x1) = Term.Bool ->
    RuleProofs.eo_has_bool_type (__eo_prog_bv_lt_self x1) := by
  intro hX1Trans hResultTy
  have hX1NotStuck : x1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation x1 hX1Trans
  have hInnerBool :
      RuleProofs.eo_has_bool_type (Term.Apply (Term.Apply (Term.UOp UserOp.bvslt) x1) x1) :=
    eo_has_bool_type_bvslt_self x1 hX1Trans hResultTy
  rw [prog_bv_lt_self_eq_of_ne_stuck x1 hX1NotStuck]
  exact RuleProofs.eo_has_bool_type_eq_of_same_smt_type
    (Term.Apply (Term.Apply (Term.UOp UserOp.bvslt) x1) x1) (Term.Boolean false)
...
private theorem eval_bvslt_self_false
  ...
  change __smtx_model_eval M (SmtTerm.bvslt (__eo_to_smt x1) (__eo_to_smt x1)) =
    SmtValue.Boolean false
  rw [__smtx_model_eval.eq_60, hEvalX1]
  simp [__smtx_model_eval_bvslt, __smtx_model_eval_bvsgt,
    ...
    __smtx_model_eval__, native_zlt, native_veq, native_not, native_and,
    native_or]
  intro hOr hA hB
...
private theorem facts___eo_prog_bv_lt_self_impl
  ...
  have hX1NotStuck : x1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation x1 hX1Trans
  have hProgBool : RuleProofs.eo_has_bool_type (__eo_prog_bv_lt_self x1) :=
    typed___eo_prog_bv_lt_self_impl x1 hX1Trans hResultTy
  rw [prog_bv_lt_self_eq_of_ne_stuck x1 hX1NotStuck]
  apply RuleProofs.eo_interprets_eq_of_rel M
  · simpa [prog_bv_lt_self_eq_of_ne_stuck x1 hX1NotStuck] using hProgBool
  · have hFalseEval :
    ...
    change RuleProofs.smt_value_rel
      (__smtx_model_eval M
        (__eo_to_smt (Term.Apply (Term.Apply (Term.UOp UserOp.bvslt) x1) x1)))
      (__smtx_model_eval M (__eo_to_smt (Term.Boolean false)))
    rw [eval_bvslt_self_false M hM x1 hX1Trans hResultTy, hFalseEval]
...
public theorem cmd_step_bv_lt_self_properties
  ...
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_lt_self args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_lt_self args premises) :=
by
  intro hCmdTrans _hPremisesBool hResultTy
  have hProg : __eo_cmd_step_proven s CRule.bv_lt_self args premises ≠ Term.Stuck :=
  ...
  | cons a1 args =>
      ...
      | nil =>
          ...
          | nil =>
              ...
              change __eo_typeof (__eo_prog_bv_lt_self a1) = Term.Bool at hResultTy
              refine ⟨?_, ?_⟩
              · intro _hTrue
                change eo_interprets M (__eo_prog_bv_lt_self a1) true
                exact facts___eo_prog_bv_lt_self_impl M hM a1 hATrans hResultTy
              · exact RuleProofs.eo_has_smt_translation_of_has_bool_type _
                  (typed___eo_prog_bv_lt_self_impl a1 hATrans hResultTy)
          | cons _ _ =>
              change Term.Stuck ≠ Term.Stuck at hProg
              exact False.elim (hProg rfl)
      | cons _ _ =>
