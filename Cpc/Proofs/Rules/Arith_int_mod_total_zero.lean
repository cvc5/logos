...
by
  ...
  have hProg : __eo_cmd_step_proven s CRule.arith_int_mod_total_zero args premises ≠ Term.Stuck :=
  ...
  | cons a1 args =>
      ...
      | nil =>
          ...
          | nil =>
              ...
              · change RuleProofs.eo_has_smt_translation (__eo_prog_arith_int_mod_total_zero T1)
