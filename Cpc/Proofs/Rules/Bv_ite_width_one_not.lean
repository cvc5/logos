...
private theorem prog_bv_ite_width_one_not_eq_of_ne_stuck (c1 : Term) :
    c1 ≠ Term.Stuck ->
    __eo_prog_bv_ite_width_one_not c1 =
      Term.Apply
...
private theorem typeof_width_one_not_ite_not_stuck_implies_cond
    (cTy : Term) :
    __eo_typeof_ite
        (__eo_typeof_eq cTy
  ...
  · exfalso
    ...
    · have hOneTy :
      ...
      have hn' : ¬ 1 = n := by
        intro h
        exact hn h.symm
      simp [__eo_typeof_ite, __eo_typeof_eq, __eo_requires, __eo_eq,
        native_ite, native_teq, native_not, hn, hn']

private theorem typeof_arg_of_prog_bv_ite_width_one_not_bool (c1 : Term) :
    __eo_typeof (__eo_prog_bv_ite_width_one_not c1) = Term.Bool ->
  ...
  · rw [prog_bv_ite_width_one_not_eq_of_ne_stuck c1 hC1] at hTy
...
private theorem smt_typeof_binary_zero_one :
  ...
  have hNN : __smtx_typeof (SmtTerm.Binary 1 0) ≠ SmtType.None := by
    native_decide
  exact TranslationProofs.smtx_typeof_binary_of_non_none 1 0 hNN
...
private theorem smt_typeof_bvnot_c1
    (c1 : Term) :
    RuleProofs.eo_has_smt_translation c1 ->
    __eo_typeof c1 = Term.Apply (Term.UOp UserOp.BitVec) (Term.Numeral 1) ->
    __smtx_typeof
  ...
  change __smtx_typeof (SmtTerm.bvnot (__eo_to_smt c1)) =
    __smtx_typeof (__eo_to_smt c1)
  rw [__smtx_typeof.eq_def] <;> simp only
  simp [__smtx_typeof_bv_op_1, hC1SmtTy]

private theorem smt_typeof_bv_ite_width_one_not
    (c1 : Term) :
    RuleProofs.eo_has_smt_translation c1 ->
    __eo_typeof (__eo_prog_bv_ite_width_one_not c1) = Term.Bool ->
    __smtx_typeof
  ...
  have hC1Type := typeof_arg_of_prog_bv_ite_width_one_not_bool c1 hResultTy
  have hC1SmtTy := smt_typeof_c1_bitvec_one c1 hC1Trans hC1Type
  have hCondTy :
      __smtx_typeof (SmtTerm.eq (__eo_to_smt c1) (SmtTerm.Binary 1 0)) =
        SmtType.Bool := by
    rw [typeof_eq_eq]
  ...
  change __smtx_typeof
    ...
    __smtx_typeof
      (__eo_to_smt (Term.Apply (Term.UOp UserOp.bvnot) c1))
  rw [typeof_ite_eq]
  rw [smt_typeof_bvnot_c1 c1 hC1Trans hC1Type]
  simp [__smtx_typeof_ite, hCondTy, hC1SmtTy, smt_typeof_bv_one_one,
    smt_typeof_bv_zero_one, native_Teq, native_ite]

private theorem typed___eo_prog_bv_ite_width_one_not_impl (c1 : Term) :
    RuleProofs.eo_has_smt_translation c1 ->
    __eo_typeof (__eo_prog_bv_ite_width_one_not c1) = Term.Bool ->
    RuleProofs.eo_has_bool_type (__eo_prog_bv_ite_width_one_not c1) := by
  intro hC1Trans hResultTy
  have hC1NotStuck : c1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation c1 hC1Trans
  rw [prog_bv_ite_width_one_not_eq_of_ne_stuck c1 hC1NotStuck]
  exact RuleProofs.eo_has_bool_type_eq_of_same_smt_type
    ...
    (by
      rw [smt_typeof_bv_ite_width_one_not c1 hC1Trans hResultTy]
      rw [smt_typeof_bvnot_c1 c1 hC1Trans
        (typeof_arg_of_prog_bv_ite_width_one_not_bool c1 hResultTy)]
      exact hC1Trans)

private theorem eval_bv_ite_width_one_not
  ...
  rw [show __smtx_model_eval M (SmtTerm.bvnot (__eo_to_smt c1)) =
      __smtx_model_eval_bvnot (__smtx_model_eval M (__eo_to_smt c1)) by
        rw [__smtx_model_eval.eq_def] <;> simp only]
  rw [hEvalC]
  ...
  · subst payload
    simp [__smtx_model_eval_eq, __smtx_model_eval_ite,
      __smtx_model_eval_bvnot, native_binary_not, native_mod_total,
      native_int_pow2, native_zexp_total, native_zplus, native_zneg,
      native_veq, hNatOne]
  · subst payload
    simp [__smtx_model_eval_eq, __smtx_model_eval_ite,
      __smtx_model_eval_bvnot, native_binary_not, native_mod_total,
...
private theorem facts___eo_prog_bv_ite_width_one_not_impl
    (M : SmtModel) (hM : model_wf M) (c1 : Term) :
    RuleProofs.eo_has_smt_translation c1 ->
    __eo_typeof (__eo_prog_bv_ite_width_one_not c1) = Term.Bool ->
    eo_interprets M (__eo_prog_bv_ite_width_one_not c1) true := by
  intro hC1Trans hResultTy
  have hC1NotStuck : c1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation c1 hC1Trans
  have hProgBool : RuleProofs.eo_has_bool_type (__eo_prog_bv_ite_width_one_not c1) :=
    typed___eo_prog_bv_ite_width_one_not_impl c1 hC1Trans hResultTy
  rw [prog_bv_ite_width_one_not_eq_of_ne_stuck c1 hC1NotStuck]
  apply RuleProofs.eo_interprets_eq_of_rel M
  · simpa [prog_bv_ite_width_one_not_eq_of_ne_stuck c1 hC1NotStuck] using hProgBool
...
public theorem cmd_step_bv_ite_width_one_not_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.bv_ite_width_one_not args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_ite_width_one_not args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_ite_width_one_not args premises) :=
by
  intro hCmdTrans _hPremisesBool hResultTy
  have hProg : __eo_cmd_step_proven s CRule.bv_ite_width_one_not args premises ≠ Term.Stuck :=
  ...
  | cons a1 args =>
      ...
      | nil =>
          ...
          | nil =>
              ...
              change __eo_typeof (__eo_prog_bv_ite_width_one_not a1) = Term.Bool
                at hResultTy
              refine ⟨?_, ?_⟩
              · intro _hTrue
                change eo_interprets M (__eo_prog_bv_ite_width_one_not a1) true
                exact facts___eo_prog_bv_ite_width_one_not_impl M hM a1
                  hA1Trans hResultTy
              · exact RuleProofs.eo_has_smt_translation_of_has_bool_type _
                  (typed___eo_prog_bv_ite_width_one_not_impl a1 hA1Trans hResultTy)
          | cons _ _ =>
              change Term.Stuck ≠ Term.Stuck at hProg
              exact False.elim (hProg rfl)
      | cons _ _ =>
