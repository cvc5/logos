...
private theorem prog_arith_int_div_total_zero_eq
    (t1 : Term)
    (hT1NotStuck : t1 ≠ Term.Stuck) :
    __eo_prog_arith_int_div_total_zero t1 =
      (Term.Apply
        (Term.Apply Term.eq (Term.Apply (Term.Apply Term.div_total t1) (Term.Numeral 0)))
        (Term.Numeral 0)) := by
  cases hTy : t1 <;> simp [__eo_prog_arith_int_div_total_zero, hTy] at hT1NotStuck ⊢

private theorem typeof_arg_of_prog_arith_int_div_total_zero_bool
    (t1 : Term)
    (hT1Trans : RuleProofs.eo_has_smt_translation t1)
    (h : __eo_typeof (__eo_prog_arith_int_div_total_zero t1) = Term.Bool) :
    __eo_typeof t1 = Term.Int := by
  have hT1NotStuck : t1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation t1 hT1Trans
  rw [prog_arith_int_div_total_zero_eq t1 hT1NotStuck] at h
  change __eo_typeof_eq (__eo_typeof (Term.Apply (Term.Apply Term.div_total t1) (Term.Numeral 0)))
...
private theorem typed___eo_prog_arith_int_div_total_zero_impl
  ...
  __eo_typeof (__eo_prog_arith_int_div_total_zero t1) = Term.Bool ->
  RuleProofs.eo_has_bool_type (__eo_prog_arith_int_div_total_zero t1) := by
  intro hT1Trans hResultTy
  have hT1Ty : __eo_typeof t1 = Term.Int :=
    typeof_arg_of_prog_arith_int_div_total_zero_bool t1 hT1Trans hResultTy
  have hT1NotStuck : t1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation t1 hT1Trans
  ...
  have hLhsTrans :
      RuleProofs.eo_has_smt_translation
        (Term.Apply (Term.Apply Term.div_total t1) (Term.Numeral 0)) := by
    simp [RuleProofs.eo_has_smt_translation, hLhsTy]
  rw [prog_arith_int_div_total_zero_eq t1 hT1NotStuck]
  exact RuleProofs.eo_has_bool_type_eq_of_same_smt_type
    (Term.Apply (Term.Apply Term.div_total t1) (Term.Numeral 0)) (Term.Numeral 0)
    (by
      rw [hLhsTy]
...
private theorem facts___eo_prog_arith_int_div_total_zero_impl
  ...
  RuleProofs.eo_has_smt_translation t1 ->
  __eo_typeof (__eo_prog_arith_int_div_total_zero t1) = Term.Bool ->
  eo_interprets M (__eo_prog_arith_int_div_total_zero t1) true := by
  intro hT1Trans hResultTy
  have hProgBool :
      RuleProofs.eo_has_bool_type (__eo_prog_arith_int_div_total_zero t1) :=
    typed___eo_prog_arith_int_div_total_zero_impl t1 hT1Trans hResultTy
  have hT1Ty : __eo_typeof t1 = Term.Int :=
    typeof_arg_of_prog_arith_int_div_total_zero_bool t1 hT1Trans hResultTy
  have hT1NotStuck : t1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation t1 hT1Trans
  have hProgEq := prog_arith_int_div_total_zero_eq t1 hT1NotStuck
  have hProgBool' :
...
public theorem cmd_step_arith_int_div_total_zero_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.arith_int_div_total_zero args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.arith_int_div_total_zero args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.arith_int_div_total_zero args premises) :=
by
  intro hCmdTrans _hPremisesBool hResultTy
  have hProg : __eo_cmd_step_proven s CRule.arith_int_div_total_zero args premises ≠ Term.Stuck :=
  ...
  | cons a1 args =>
      ...
      | nil =>
          ...
          | nil =>
              ...
              change __eo_typeof (__eo_prog_arith_int_div_total_zero T1) = Term.Bool at hResultTy
              refine ⟨?_, ?_⟩
              · intro _hTrue
                change eo_interprets M (__eo_prog_arith_int_div_total_zero T1) true
                exact facts___eo_prog_arith_int_div_total_zero_impl M hM T1 hT1Trans hResultTy
              · change RuleProofs.eo_has_smt_translation (__eo_prog_arith_int_div_total_zero T1)
