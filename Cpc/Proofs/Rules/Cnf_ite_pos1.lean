...
public theorem cmd_step_cnf_ite_pos1_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.cnf_ite_pos1 args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.cnf_ite_pos1 args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.cnf_ite_pos1 args premises) :=
by
  intro hCmdTrans _hPremisesBool hResultTy
  have hProg : __eo_cmd_step_proven s CRule.cnf_ite_pos1 args premises ≠ Term.Stuck :=
  ...
  | cons F args =>
      ...
      | nil =>
          cases premises with
          | nil =>
              change __eo_prog_cnf_ite_pos1 F ≠ Term.Stuck at hProg
              change __eo_typeof (__eo_prog_cnf_ite_pos1 F) = Term.Bool at hResultTy
              cases F with
              | Apply f F2 =>
                  cases f with
                  | Apply g F1 =>
                              ...
                              | ite =>
                                  ...
                                  have hResultTrue :
                                    ...
                                    · rcases CnfSupport.eo_interprets_bool_cases M hM F1 hF1Bool with
                                        hF1True | hF1False
                                      · simpa [__eo_prog_cnf_ite_pos1] using
