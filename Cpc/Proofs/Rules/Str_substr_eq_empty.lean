...
private theorem facts___eo_prog_str_substr_eq_empty_impl
    (M : SmtModel) (hM : model_wf M) (s r n m Pn Pm Pr T : Term)
...
public theorem cmd_step_str_substr_eq_empty_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.str_substr_eq_empty args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.str_substr_eq_empty args premises) = Term.Bool ->
