...
private theorem prog_bv_lshr_by_const_0_eq_of_ne_stuck (x1 sz1 : Term) :
    x1 ≠ Term.Stuck ->
    sz1 ≠ Term.Stuck ->
    __eo_prog_bv_lshr_by_const_0 x1 sz1 =
      Term.Apply (Term.Apply (Term.UOp UserOp.eq)
        (Term.Apply (Term.Apply (Term.UOp UserOp.bvlshr) x1)
          (Term.Apply (Term.UOp1 UserOp1.int_to_bv sz1) (Term.Numeral 0)))) x1 := by
  intro hX1 hSz1
  cases x1 <;> cases sz1 <;> simp [__eo_prog_bv_lshr_by_const_0] at hX1 hSz1 ⊢

private theorem typeof_args_of_prog_bv_lshr_by_const_0_bool (x1 sz1 : Term) :
  ...
  · by_cases hSz1 : sz1 = Term.Stuck
    · subst sz1
      cases x1 <;> simp [__eo_prog_bv_lshr_by_const_0] at hX1 hTy
      all_goals
        have hStuckTy : __eo_typeof Term.Stuck ≠ Term.Bool := by
          native_decide
        exact False.elim (hStuckTy hTy)
    · rw [prog_bv_lshr_by_const_0_eq_of_ne_stuck x1 sz1 hX1 hSz1] at hTy
...
private theorem smt_typeof_bvlshr_const_zero_eq_self
    (x1 sz1 : Term) :
    RuleProofs.eo_has_smt_translation x1 ->
    __eo_typeof (__eo_prog_bv_lshr_by_const_0 x1 sz1) = Term.Bool ->
    __smtx_typeof
  ...
  rcases typeof_args_of_prog_bv_lshr_by_const_0_bool x1 sz1 hResultTy with
    ⟨w, hX1Type, hSz1, _hW⟩
...
private theorem typed___eo_prog_bv_lshr_by_const_0_impl (x1 sz1 : Term) :
    RuleProofs.eo_has_smt_translation x1 ->
    __eo_typeof (__eo_prog_bv_lshr_by_const_0 x1 sz1) = Term.Bool ->
    RuleProofs.eo_has_bool_type (__eo_prog_bv_lshr_by_const_0 x1 sz1) := by
  intro hX1Trans hResultTy
  ...
  rcases typeof_args_of_prog_bv_lshr_by_const_0_bool x1 sz1 hResultTy with
    ⟨w, hX1Type, hSz1, hW⟩
  subst sz1
  rw [prog_bv_lshr_by_const_0_eq_of_ne_stuck x1 w hX1NotStuck hW]
  exact RuleProofs.eo_has_bool_type_eq_of_same_smt_type
    (Term.Apply (Term.Apply (Term.UOp UserOp.bvlshr) x1)
      (Term.Apply (Term.UOp1 UserOp1.int_to_bv w) (Term.Numeral 0)))
    x1
    (smt_typeof_bvlshr_const_zero_eq_self x1 w hX1Trans (by simpa using hResultTy))
    (by
      rw [smt_typeof_bvlshr_const_zero_eq_self x1 w hX1Trans (by simpa using hResultTy)]
      rcases smt_bitvec_type_of_eo_bitvec_type_with_width x1 w hX1Trans hX1Type with
...
private theorem eval_bvlshr_const_zero_self
  ...
  simp [__smtx_model_eval_bvlshr, SmtEval.native_div_total,
    SmtEval.native_mod_total, hPowZero, hDivZero, hPayloadMod,
    hPayloadModInt]
...
private theorem facts___eo_prog_bv_lshr_by_const_0_impl
  ...
  rcases typeof_args_of_prog_bv_lshr_by_const_0_bool x1 sz1 hResultTy with
    ⟨w, _hX1Type, hSz1, hW⟩
  subst sz1
  have hProgBool : RuleProofs.eo_has_bool_type (__eo_prog_bv_lshr_by_const_0 x1 w) :=
    typed___eo_prog_bv_lshr_by_const_0_impl x1 w hX1Trans (by simpa using hResultTy)
  rw [prog_bv_lshr_by_const_0_eq_of_ne_stuck x1 w hX1NotStuck hW]
  apply RuleProofs.eo_interprets_eq_of_rel M
  · simpa [prog_bv_lshr_by_const_0_eq_of_ne_stuck x1 w hX1NotStuck hW] using hProgBool
      ...
      (__smtx_model_eval M
        (__eo_to_smt
          (Term.Apply (Term.Apply (Term.UOp UserOp.bvlshr) x1)
            (Term.Apply (Term.UOp1 UserOp1.int_to_bv w) (Term.Numeral 0)))))
      (__smtx_model_eval M (__eo_to_smt x1))
    rw [eval_bvlshr_const_zero_self M hM x1 w hX1Trans (by simpa using hResultTy)]
...
public theorem cmd_step_bv_lshr_by_const_0_properties
  ...
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_lshr_by_const_0 args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_lshr_by_const_0 args premises) :=
by
  intro hCmdTrans _hPremisesBool hResultTy
  have hProg : __eo_cmd_step_proven s CRule.bv_lshr_by_const_0 args premises ≠ Term.Stuck :=
      ...
      | cons a2 args =>
          ...
          | nil =>
              ...
              | nil =>
                  ...
                  change __eo_typeof (__eo_prog_bv_lshr_by_const_0 a1 a2) = Term.Bool
                    at hResultTy
                  refine ⟨?_, ?_⟩
                  · intro _hTrue
                    change eo_interprets M (__eo_prog_bv_lshr_by_const_0 a1 a2) true
                    exact facts___eo_prog_bv_lshr_by_const_0_impl M hM a1 a2
                      hA1Trans hResultTy
                  · exact RuleProofs.eo_has_smt_translation_of_has_bool_type _
                      (typed___eo_prog_bv_lshr_by_const_0_impl a1 a2 hA1Trans hResultTy)
              | cons _ _ =>
                  change Term.Stuck ≠ Term.Stuck at hProg
                  exact False.elim (hProg rfl)
          | cons _ _ =>
