...
private abbrev bvultTerm (t s : Term) : Term :=
  Term.Apply (Term.Apply (Term.UOp UserOp.bvult) t) s

private abbrev ubvToIntTerm (t : Term) : Term :=
  Term.Apply (Term.UOp UserOp.ubv_to_int) t

private abbrev ubvLtTerm (t s : Term) : Term :=
  Term.Apply (Term.Apply (Term.UOp UserOp.lt) (ubvToIntTerm t)) (ubvToIntTerm s)
...
private theorem prog_uf_int2bv_bvult_equiv_eq_of_ne_stuck (t1 s1 : Term) :
    t1 ≠ Term.Stuck ->
    s1 ≠ Term.Stuck ->
    __eo_prog_uf_int2bv_bvult_equiv t1 s1 =
      ufInt2bvBvultConclusion t1 s1 := by
  intro hT1 hS1
  cases t1 <;> cases s1 <;>
    simp [__eo_prog_uf_int2bv_bvult_equiv, ufInt2bvBvultConclusion,
      bvultTerm, ubvLtTerm, ubvToIntTerm] at hT1 hS1 ⊢
...
private theorem typeof_args_of_prog_uf_int2bv_bvult_equiv_bool (t1 s1 : Term) :
  ...
  · by_cases hS1 : s1 = Term.Stuck
    · subst s1
      cases t1 <;> simp [__eo_prog_uf_int2bv_bvult_equiv] at hT1 hTy
      all_goals
        have hStuckTy : __eo_typeof Term.Stuck ≠ Term.Bool := by
          native_decide
        exact False.elim (hStuckTy hTy)
    · rw [prog_uf_int2bv_bvult_equiv_eq_of_ne_stuck t1 s1 hT1 hS1] at hTy
...
private theorem smt_typeof_bvult_term_eq
    (t1 s1 : Term) :
    RuleProofs.eo_has_smt_translation t1 ->
    RuleProofs.eo_has_smt_translation s1 ->
    __eo_typeof (__eo_prog_uf_int2bv_bvult_equiv t1 s1) = Term.Bool ->
    __smtx_typeof (__eo_to_smt (bvultTerm t1 s1)) = SmtType.Bool := by
  intro hT1Trans hS1Trans hResultTy
  rcases typeof_args_of_prog_uf_int2bv_bvult_equiv_bool t1 s1 hResultTy with
...
private theorem smt_typeof_ubv_lt_term_eq
    (t1 s1 : Term) :
    RuleProofs.eo_has_smt_translation t1 ->
    RuleProofs.eo_has_smt_translation s1 ->
    __eo_typeof (__eo_prog_uf_int2bv_bvult_equiv t1 s1) = Term.Bool ->
    __smtx_typeof (__eo_to_smt (ubvLtTerm t1 s1)) = SmtType.Bool := by
  intro hT1Trans hS1Trans hResultTy
  rcases typeof_args_of_prog_uf_int2bv_bvult_equiv_bool t1 s1 hResultTy with
    ⟨w, hT1Type, hS1Type, _hW⟩
  rcases smt_bitvec_type_of_eo_bitvec_type_with_width t1 w hT1Trans hT1Type with
  ...
  change __smtx_typeof
    ...
    SmtType.Bool
  rw [typeof_lt_eq, smtx_typeof_ubv_to_int_term_eq,
    smtx_typeof_ubv_to_int_term_eq]
  simp [__smtx_typeof_bv_op_1_ret, __smtx_typeof_arith_overload_op_2_ret,
    hT1SmtTy, hS1SmtTy]

private theorem typed___eo_prog_uf_int2bv_bvult_equiv_impl
    (t1 s1 : Term) :
    RuleProofs.eo_has_smt_translation t1 ->
    RuleProofs.eo_has_smt_translation s1 ->
    __eo_typeof (__eo_prog_uf_int2bv_bvult_equiv t1 s1) = Term.Bool ->
    RuleProofs.eo_has_bool_type (__eo_prog_uf_int2bv_bvult_equiv t1 s1) := by
  intro hT1Trans hS1Trans hResultTy
  ...
  have hBvultTy :
      __smtx_typeof (__eo_to_smt (bvultTerm t1 s1)) = SmtType.Bool :=
    smt_typeof_bvult_term_eq t1 s1 hT1Trans hS1Trans hResultTy
  have hUbvLtTy :
      __smtx_typeof (__eo_to_smt (ubvLtTerm t1 s1)) = SmtType.Bool :=
    smt_typeof_ubv_lt_term_eq t1 s1 hT1Trans hS1Trans hResultTy
  rw [prog_uf_int2bv_bvult_equiv_eq_of_ne_stuck t1 s1 hT1NotStuck hS1NotStuck]
  exact RuleProofs.eo_has_bool_type_eq_of_same_smt_type
    (bvultTerm t1 s1) (ubvLtTerm t1 s1)
    (by rw [hBvultTy, hUbvLtTy])
...
private theorem eval_bvult_matches_ubv_lt
    ...
    RuleProofs.eo_has_smt_translation s1 ->
    __eo_typeof (__eo_prog_uf_int2bv_bvult_equiv t1 s1) = Term.Bool ->
    __smtx_model_eval M (__eo_to_smt (bvultTerm t1 s1)) =
      __smtx_model_eval M (__eo_to_smt (ubvLtTerm t1 s1)) := by
  intro hT1Trans hS1Trans hResultTy
  rcases typeof_args_of_prog_uf_int2bv_bvult_equiv_bool t1 s1 hResultTy with
    ⟨w, hT1Type, hS1Type, _hW⟩
  rcases smt_bitvec_type_of_eo_bitvec_type_with_width t1 w hT1Trans hT1Type with
  ...
  change __smtx_model_eval M (SmtTerm.bvult (__eo_to_smt t1) (__eo_to_smt s1)) =
    __smtx_model_eval M
      (SmtTerm.lt (SmtTerm.ubv_to_int (__eo_to_smt t1))
        (SmtTerm.ubv_to_int (__eo_to_smt s1)))
...
private theorem facts___eo_prog_uf_int2bv_bvult_equiv_impl
    ...
    RuleProofs.eo_has_smt_translation s1 ->
    __eo_typeof (__eo_prog_uf_int2bv_bvult_equiv t1 s1) = Term.Bool ->
    eo_interprets M (__eo_prog_uf_int2bv_bvult_equiv t1 s1) true := by
  intro hT1Trans hS1Trans hResultTy
  have hT1NotStuck : t1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation t1 hT1Trans
  have hS1NotStuck : s1 ≠ Term.Stuck :=
    RuleProofs.term_ne_stuck_of_has_smt_translation s1 hS1Trans
  have hProgBool : RuleProofs.eo_has_bool_type (__eo_prog_uf_int2bv_bvult_equiv t1 s1) :=
    typed___eo_prog_uf_int2bv_bvult_equiv_impl t1 s1 hT1Trans hS1Trans hResultTy
  rw [prog_uf_int2bv_bvult_equiv_eq_of_ne_stuck t1 s1 hT1NotStuck hS1NotStuck]
  apply RuleProofs.eo_interprets_eq_of_rel M
  · simpa [prog_uf_int2bv_bvult_equiv_eq_of_ne_stuck t1 s1 hT1NotStuck
      hS1NotStuck] using hProgBool
  · change RuleProofs.smt_value_rel
      (__smtx_model_eval M (__eo_to_smt (bvultTerm t1 s1)))
      (__smtx_model_eval M (__eo_to_smt (ubvLtTerm t1 s1)))
...
public theorem cmd_step_uf_int2bv_bvult_equiv_properties
  ...
  __eo_typeof (__eo_cmd_step_proven s CRule.uf_int2bv_bvult_equiv args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.uf_int2bv_bvult_equiv args premises) :=
by
  intro hCmdTrans _hPremisesBool hResultTy
  have hProg : __eo_cmd_step_proven s CRule.uf_int2bv_bvult_equiv args premises ≠ Term.Stuck :=
      ...
      | cons a2 args =>
          ...
          | nil =>
              ...
              | nil =>
                  ...
                  change __eo_typeof (__eo_prog_uf_int2bv_bvult_equiv a1 a2) =
                    Term.Bool at hResultTy
                  refine ⟨?_, ?_⟩
                  · intro _hTrue
                    change eo_interprets M (__eo_prog_uf_int2bv_bvult_equiv a1 a2) true
                    exact facts___eo_prog_uf_int2bv_bvult_equiv_impl M hM a1 a2
                      hA1Trans hA2Trans hResultTy
                  · exact RuleProofs.eo_has_smt_translation_of_has_bool_type _
                      (typed___eo_prog_uf_int2bv_bvult_equiv_impl a1 a2 hA1Trans
                        hA2Trans hResultTy)
              | cons _ _ =>
                  change Term.Stuck ≠ Term.Stuck at hProg
                  exact False.elim (hProg rfl)
