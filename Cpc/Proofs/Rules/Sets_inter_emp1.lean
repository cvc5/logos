...
public theorem cmd_step_sets_inter_emp1_properties
  ...
  __eo_typeof (__eo_cmd_step_proven s CRule.sets_inter_emp1 args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.sets_inter_emp1 args premises) :=
by
              ...
              | nil =>
                  ...
                  | cons n premises =>
                      ...
                      | nil =>
                          ...
                          change
                            __eo_typeof
                                (__eo_prog_sets_inter_emp1 x y ty
                                  (Proof.pf P)) = Term.Bool at hResultTy
                          have hProgRule :
                              __eo_prog_sets_inter_emp1 x y ty
                                  (Proof.pf P) ≠ Term.Stuck :=
                            term_ne_stuck_of_typeof_bool hResultTy
                          rcases SetsBasicRewritesSupport.prog_sets_inter_emp1_info
                          ...
                          · intro hTrue
                            ...
                            exact RuleProofs.eo_interprets_eq_of_rel M
                              (SetsBasicRewritesSupport.mkSetInter x y) x
                              hFormulaBool
                              (SetsBasicRewritesSupport.set_inter_empty_left_rel_of_premise_bool
