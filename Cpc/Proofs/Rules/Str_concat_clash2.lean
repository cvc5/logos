...
private theorem prog_str_concat_clash2_info
    (x y ys P1 P2 : Term)
    (hProg : __eo_prog_str_concat_clash2 x y ys (Proof.pf P1)
      (Proof.pf P2) ≠ Term.Stuck) :
    P1 = concatClashNePremise x y ∧
      P2 = concatClashLenPremise x y ∧
      __eo_prog_str_concat_clash2 x y ys (Proof.pf P1) (Proof.pf P2) =
        concatClash2Conclusion x y ys := by
  unfold __eo_prog_str_concat_clash2 at hProg
  ...
  next heq1 heq2 =>
    ...
    subst_vars
    refine ⟨rfl, rfl, ?_⟩
    simp [__eo_prog_str_concat_clash2, __eo_requires, __eo_eq, __eo_and,
      native_ite, native_teq, native_and, SmtEval.native_not,
      concatClash2Conclusion, mkEq, mkConcat]

public theorem cmd_step_str_concat_clash2_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.str_concat_clash2 args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.str_concat_clash2 args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.str_concat_clash2 args premises) :=
by
                  ...
                  | cons n1 premises =>
                      ...
                      | cons n2 premises =>
                          ...
                          | nil =>
                              ...
                              change __eo_typeof
                                  (__eo_prog_str_concat_clash2 a1 a2 a3
                              ...
                              have hRuleProg :
                                  __eo_prog_str_concat_clash2 a1 a2 a3
                                    ...
                                    Term.Stuck :=
                                term_ne_stuck_of_typeof_bool hResultTy
                              rcases prog_str_concat_clash2_info
                                  a1 a2 a3 P1 P2 hRuleProg with
                                ⟨hP1, hP2, hProgEq⟩
                              have hConclusionTy :
                                  __eo_typeof
                                      (concatClash2Conclusion a1 a2 a3) =
                                    Term.Bool := by
                                simpa [hProgEq] using hResultTy
                              rcases concat_clash2_smt_seq_types_of_eo_type
                                  a1 a2 a3 hA1Trans hA2Trans hA3Trans
                                  hConclusionTy with
                                ⟨T, hA1Ty, hA2Ty, hA3Ty⟩
                              have hBool := eo_has_bool_type_concat_clash2
                                a1 a2 a3 T hA1Ty hA2Ty hA3Ty
                              refine ⟨?_, ?_⟩
                              · intro hTrue
                                ...
                                rw [hProgEq]
                                exact eo_interprets_concat_clash2 M hM
                                  a1 a2 a3 T hA1Ty hA2Ty hA3Ty
                                  hPrem1 hPrem2
