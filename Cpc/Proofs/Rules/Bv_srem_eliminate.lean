...
public import Cpc.Proofs.RuleSupport.BvSremElimSupport
import all Cpc.Proofs.RuleSupport.BvSremElimSupport
...
public theorem cmd_step_bv_srem_eliminate_properties
    (M : SmtModel) (hM : model_wf M)
    (s : CState) (args : CArgList) (premises : CIndexList) :
  cmdTranslationOk (CCmd.step CRule.bv_srem_eliminate args premises) ->
  AllHaveBoolType (premiseTermList s premises) ->
  __eo_typeof (__eo_cmd_step_proven s CRule.bv_srem_eliminate args premises) = Term.Bool ->
  StepRuleProperties M (premiseTermList s premises)
    (__eo_cmd_step_proven s CRule.bv_srem_eliminate args premises) :=
by
                  ...
                  | cons n1 premises =>
                      ...
                      | nil =>
                          ...
                          change StepRuleProperties M [P1]
                            (__eo_prog_bv_srem_eliminate a1 a2 a3
                              (Proof.pf P1))
                          have hProgLocal :
                              __eo_prog_bv_srem_eliminate a1 a2 a3
                          ...
                          have hResultTyCanonical :
                              __eo_typeof (bvSremProgram a1 a2 a3) =
                                Term.Bool := by
                            have h := hResultTy
                            change __eo_typeof
                                (__eo_prog_bv_srem_eliminate a1 a2 a3
                              ...
                              Term.Bool at h
                            simpa [P1, hP1, bvSremProgram] using h
                          simpa [hP1, bvSremProgram] using
                            (show StepRuleProperties M
                                [bvSdivPrem a1 a3]
                                (bvSremProgram a1 a2 a3) from
                              ⟨(by
                                  intro hPremisesTrue
                                  have hPrem :
                                      eo_interprets M
                                  ...
                                  exact facts_bv_srem_program M hM a1 a2 a3
                                    hA1Trans hA2Trans hA3Trans hPrem
                                    hResultTyCanonical),
                                RuleProofs.eo_has_smt_translation_of_has_bool_type _
                                  (typed_bv_srem_program a1 a2 a3
