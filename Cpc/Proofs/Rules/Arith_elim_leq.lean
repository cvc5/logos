...
public theorem cmd_step_arith_elim_leq_properties
...
by
  ...
  have hProg : __eo_cmd_step_proven s CRule.arith_elim_leq args premises ≠ Term.Stuck :=
      ...
      | cons a2 args =>
          ...
          | nil =>
              ...
              | nil =>
                  ...
                  change __eo_typeof (__eo_prog_arith_elim_leq T1 S1) = Term.Bool at hResultTy
                  refine ⟨?_, ?_⟩
                  · intro _hTrue
                    change eo_interprets M (__eo_prog_arith_elim_leq T1 S1) true
                    exact ArithSimpleSupport.facts_arith_elim_leq
                      M hM T1 S1 hT1Trans hS1Trans hResultTy
                  · change RuleProofs.eo_has_smt_translation
                      (__eo_prog_arith_elim_leq T1 S1)
                    exact RuleProofs.eo_has_smt_translation_of_has_bool_type
                      (__eo_prog_arith_elim_leq T1 S1)
                      (ArithSimpleSupport.typed_arith_elim_leq
