...
This is the whole of what `Cpc/Proofs/CheckerState.lean` and its dependants
...
Agreement of two models on the global (non-variable) assignment.  The checker
needs it to say that a proven fact stays true in a variable-variant model.
-/
