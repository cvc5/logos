...
| [`parametric-datatypes.md`](parametric-datatypes.md) | the plan for parametric datatypes: the design, what `ethos-eoc` has to generate for it, and what the parser already does |
